...
bool License::GetComputerHardwareId() // OK
{
	...
	wsprintf(SPKHW,"Your HWID is not work. Please register new ID.\nYour ID: %08X-%08X-%08X-%08X\nPhone for help: 0775 838 858",ComputerHardwareId1,ComputerHardwareId2,ComputerHardwareId3,ComputerHardwareId4);
...
inline void License::ErrorMessageBox() // OK
{
	...
	MessageBox(0,SPKHW,"Unregistered",MB_ICONSTOP|MB_OK);
