...
void CMemoryAllocator::BindMemoryAllocatorInfo(int index,CMemoryAllocatorInfo MemoryAllocatorInfo) // OK
{
	...
	if(OBJECT_USER_RANGE(index) != 0)
	{
		...
		#endif
		#else
		lpObj->EquipInventory1 = MemoryAllocatorInfo.m_EquipInventory1;
		lpObj->EquipInventory2 = MemoryAllocatorInfo.m_EquipInventory2;
		lpObj->EquipInventoryMap1 = MemoryAllocatorInfo.m_EquipInventoryMap1;
		lpObj->EquipInventoryMap2 = MemoryAllocatorInfo.m_EquipInventoryMap2;
		#endif
		...
		#if(SAU_ANTIHACK)
		lpObj->BUserAttack = MemoryAllocatorInfo.m_BUserAttack;
		#endif
#if(HT_THUE_FLAG)
		lpObj->mInfoBuyFlag = MemoryAllocatorInfo.m_mInfoBuyFlag;
#endif
