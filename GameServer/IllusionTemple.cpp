...
void CIllusionTemple::CGIllusionTempleButtonClickRecv(int aIndex) // OK
{
	...
	switch(level)
	{
		case 0:			gItemBagManager.DropItemBySpecialValue(ITEM_BAG_ILLUSION_TEMPLE1,lpObj,lpObj->Map,lpObj->X,lpObj->Y);			break;
		case 1:			gItemBagManager.DropItemBySpecialValue(ITEM_BAG_ILLUSION_TEMPLE2,lpObj,lpObj->Map,lpObj->X,lpObj->Y);			break;
		case 2:			gItemBagManager.DropItemBySpecialValue(ITEM_BAG_ILLUSION_TEMPLE3,lpObj,lpObj->Map,lpObj->X,lpObj->Y);			break;
		case 3:			gItemBagManager.DropItemBySpecialValue(ITEM_BAG_ILLUSION_TEMPLE4,lpObj,lpObj->Map,lpObj->X,lpObj->Y);			break;
		case 4:			gItemBagManager.DropItemBySpecialValue(ITEM_BAG_ILLUSION_TEMPLE5,lpObj,lpObj->Map,lpObj->X,lpObj->Y);			break;
		case 5:			gItemBagManager.DropItemBySpecialValue(ITEM_BAG_ILLUSION_TEMPLE6,lpObj,lpObj->Map,lpObj->X,lpObj->Y);			break;
	}

	if (this->m_IllusionTempleReward[level][0] > 0 || this->m_IllusionTempleReward[level][1] > 0 || this->m_IllusionTempleReward[level][2] > 0)
	{
		GDSetCoinSend(lpUser->Index, this->m_IllusionTempleReward[level][0], this->m_IllusionTempleReward[level][1], this->m_IllusionTempleReward[level][2], 0, 0, "IT");
...
void CIllusionTemple::StartIT()
{
	...
	LogAdd(LOG_EVENT,"[Set IT Start] At %2d:%2d:00",hour,minute);
