...
void CMossMerchant::MainProc() // OK
{
	...
	switch(this->m_State)
	{
		case MOSS_STATE_BLANK:			this->ProcState_BLANK();			break;
		case MOSS_STATE_EMPTY:			this->ProcState_EMPTY();			break;
		case MOSS_STATE_START:			this->ProcState_START();			break;
	}
}
...
void CMossMerchant::SetState(int state) // OK
{
	...
	switch(this->m_State)
	{
		case MOSS_STATE_BLANK:			this->SetState_BLANK();			break;
		case MOSS_STATE_EMPTY:			this->SetState_EMPTY();			break;
		case MOSS_STATE_START:			this->SetState_START();			break;
	}
}
