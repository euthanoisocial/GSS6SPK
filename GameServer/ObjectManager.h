...
public:
	...
	void CharacterCalcExperienceSplit(LPOBJ lpObj,LPOBJ lpMonster,float damage,int flag);
	void CharacterCalcExperienceAlone(LPOBJ lpObj,LPOBJ lpMonster,float damage,int flag,bool type,float AttackDamage);
	void CharacterCalcExperienceParty(LPOBJ lpObj,LPOBJ lpMonster,float damage,int flag);
	...
	void CharacterLifeCheck(LPOBJ lpObj,LPOBJ lpTarget,float damage,int DamageType,int flag,int type,int skill,float ShieldDamage);
};
