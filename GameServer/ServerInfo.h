...
public:
	...
	#if(ADD_POINT)
	void ReadClientInterfaceInfo();
	int m_QuickAddButton;
	int m_ResetStatButton;
	#endif
public:
	...
	int m_IpLimitConnectionTime;
	int m_IpConnectionBlockedTime;
	int m_MaxHwidConnection[MAX_ACCOUNT_LEVEL];
	DWORD m_GameGuardCRC;
	DWORD m_VerifyCRC;
	DWORD m_MainDLLCRC;
	DWORD m_MainEXECRC;
	...
	int m_ElfBufferTime[MAX_ACCOUNT_LEVEL];
	...
	#endif
	int VaultBuyShop;
	int m_ThoiGianMuaHang;
	int m_DelayBuyShop;
	int m_DelayBuyXShop;
	int m_ThoiGianQH;
	int m_GioiHanUpGuild;
	int m_MaxEventLine;
	int DeleteDupeItem;
	int DisconectDupeItem;
	//============
	...
	int m_FlyingDragonsOnlyBossMapSwitch; //Dragones Only Boss Map Switch
	...
	int m_HornOfFenrirGoldMixRate[MAX_ACCOUNT_LEVEL];
	...
	int m_MGDamageMultiplierConstA;
	...
	int m_MGDamageMultiplierMaxRate;
	int m_ELFDamageMultiplierMaxRate;
	int m_SUDamageMultiplierMaxRate;
	int m_DWDamageMultiplierMaxRate;
	int m_MGDamageMultiplierRatePhysic;
	...
	#if(TIDUS_FIX_MT)
	int m_DarkSpiritAttackSuccessRateConstD;
	int m_DarkSpiritAttackSuccessRateConstE;
	#endif
	int GioiHanTyLeX2SatThuong;
	int GioiHanTyLeX3SatThuong;
	int GioiHanTyLeSatThuongChiMang;
	int GioiHanTyLeSatThuongHoanHao;

	int m_SatanIncDamageConstA;
	int m_DinorantIncDamageConstA;
	int m_BlackFenrirIncDamageConstA;
	int m_GodenFenrirIncDamageConstA;
	...
	int m_GodenFenrirDecDamageConstA;
	...
	#if(RESET_WCOIN)
	int m_CommandResetPayment[MAX_ACCOUNT_LEVEL];
	#endif
	...
	int m_CommandResetAddReward;

	int m_CommandResetAddWCoinC[MAX_ACCOUNT_LEVEL];
	int m_CommandResetAddWCoinP[MAX_ACCOUNT_LEVEL];
	int m_CommandResetAddGPoin[MAX_ACCOUNT_LEVEL];


	int m_CommandResetPointRate[MAX_CLASS];
	int m_CommandResetKeepDLCommandPoint[MAX_ACCOUNT_LEVEL];
	int m_CommandResetAddPoinLeadership[MAX_ACCOUNT_LEVEL];
	...
	int m_GreaterIgnoreDefenseMaxRate;

#if(FIX_CHOANG_MUI_TEN_BANG)
	int ElfNoBoltArrow;
	int TyLeRaChoangSkillMasterNguTien;
	int ThoiGianChoangSkillMasterNguTien;
#endif
	...
	int TyleComBo1Skill;
#endif
	int SkillDocDW,ThoiGianDameDocDW,DameSkillSocGioDK,SkillDamGioLan;
	...
	char m_AnnounceChaosMix15[50];
	char m_AnnounceChaosMix14[50];
	char m_AnnounceChaosMix13[50];
	char m_AnnounceChaosMix12[50];
	char m_AnnounceChaosMix11[50];
	char m_AnnounceChaosMix10[50];
	char m_AnnounceChaosMixFailed[50];
	// REI DO MU
	int m_ReiDoMUEvent;
	int m_ReiDoMUMap;
	int m_ReiDoMUCordX;
	...
	int m_ClearMasterChangeClass;
	int m_DeleteQuestChangeClass;
	#if(NOTICE_PKSYSTEM)
	char PK_ColorMessPVP[10];
	char PK_ColorMessPVM[10];
	DWORD PK_DelayMess;
	#endif
	...
	int m_BatTatBloodVIP;
	int m_MocKillQuaiBloodVIP;
	int m_LevelBloodVIP;
	
	int m_BatTatDevilVIP;
	int m_MocKillQuaiDevilVIP;
	int m_LevelDevilVIP;
	//Start Event
	//Custom EventTime
	...
	int m_XdameHackSkillEnable;
	int m_XdameHackSkillPenalty;
	int m_XdameHackSkillDebug;
	int m_XdameHackSkillType;
	int m_XdameHackSkillDialog;
	int m_timedongbang;
...
#if(DROP_ITEMBAG)
	int m_BatTatDropItemBag;
	int m_DropRateItemBagVK1;
	int m_DropRateItemBagVK2;
	int m_DropRateItemBagVK4;
	int m_DropRateItemBagVK8;
	int m_DropRateItemBagVK16;
	int m_DropRateItemBagVK32;
	int m_DropRateItemBagSet1;
	int m_DropRateItemBagSet2;
	int m_DropRateItemBagSet4;
	int m_DropRateItemBagSet8;
	int m_DropRateItemBagSet16;
	int m_DropRateItemBagSet32;
#endif
	...
	int ResetNgay;
#endif
	int m_SoTranChamChien;
	int m_SoPhongDauCaCuoc;
	int m_Tylenhantien;
	int m_LoaiTienNhan;
	int m_QuyetDau;
	int m_GioiHanTienCuocQuyetDau;
	int m_TienCuocQuyetDau;
	int m_TienTrinhQuyetDau;
	int m_ItemPowerDame;
