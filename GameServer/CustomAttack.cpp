...
void CCustomAttack::DGCustomAttackResumeRecv(SDHP_CARESUME_RECV* lpMsg) // OK
{
	...
	lpObj->AutoResetEnable = ( gServerInfo.m_CommandResetAutoEnable[lpObj->AccountLevel] == 0 ) ? 0 : lpMsg->autoreset;
	...
	lpObj->AutoResetVipEnable = lpMsg->autoresetvip;
	#endif
#endif
}
...
void CCustomAttack::DGCustomAttackResumeSaveSend(int Index)
{
	...
	#if(RESET_VIP_AUTO_ON)
	pMsg.autoresetvip = lpObj->AutoResetVipEnable;
	#endif
