...
public:
	...
	void GDCashShopAddPointSaveSend(int aIndex, char* GiftAccount, DWORD AddWCoinC, DWORD AddWCoinP, DWORD AddGoblinPoint, DWORD AddRuud, DWORD AddCoinAtm);
	void GDCashShopSubPointSaveSend(int aIndex,char* GiftAccount,DWORD SubWCoinC,DWORD SubWCoinP,DWORD SubGoblinPoint, DWORD SubRuud, DWORD SubCoinAtm);
	...
	void GCSendCoin(LPOBJ lpObj, int coin1, int coin2, int coin3, int Ruud, int CoinAtm);
	#if(SOIITEM)
